    ...
    <footer className="relative border-t border-white/10 bg-background/50 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                key={social.name}
                href="#"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-muted-foreground transition-all hover:border-purple-500/50 hover:text-purple-400"
        ...
        <div className="mt-8 border-t border-white/5 pt-8 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Portfolio. Built with Next.js, Three.js & GSAP.</p>
        </div>
      </div>
    </footer>
  );
